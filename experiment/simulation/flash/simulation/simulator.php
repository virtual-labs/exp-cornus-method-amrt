...
<?php include('breadcum.php'); ?>
  ...
  <blockquote> 
    <span class="title">Cornus Method</span>
...
<p align="center"><iframe src="<?= 'vlab/'.$sub.'/'.$brch.'/'.$sim.'/'.'CornusMethod.html'?>" frameborder="0" height="600" width="800" scrolling="no"></iframe></p>
